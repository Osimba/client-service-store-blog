...
class Categories
{
    ...
    function __construct() {
        global $Database; //gives access to database variable created in init.php file
    ...
    */
    ...
    public function create_category_nav($active = NULL) {
        ...
        $data .= '><a href="' . SITE_PATH . 'store.php">View All</a></li>';
        ...
        if ( ! empty($categories)) {
            ...
            foreach($categories as $category) {
                ...
                $data .= '><a href="' . SITE_PATH . 'store.php?id=' . $category['id'] . '">' . $category['name'] . '</a></li>';
            }
        }
        return $data;
    }
