...
/*
    Template Class
    Handle all templating tasks - displaying views, alers, errors and view data
*/
...
class Template
{
    ...
    */
    ...
    public function set_data($name, $value, $clean = FALSE) {
        if ($clean == TRUE) {
            $this->data[$name] = htmlentities($value, ENT_QUOTES); //make sure html escaped properly
        }
        else {
    ...
    /**
     * Retrieves  data based on provided name for access later
     * 
     * @access public
     * @param  string, bool
     * @return string
